        ...
        void _state_1() {
            if(this->state == 1) {
                ...
                else
                {
                    ...
                    this->ax_offset = this->storage.data.ax_offset;
                    this->ay_offset = this->storage.data.ay_offset;
                    this->az_offset = this->storage.data.az_offset;
                    this->gx_offset = this->storage.data.gx_offset;
                    this->gy_offset = this->storage.data.gy_offset;
                    this->gz_offset = this->storage.data.gz_offset;
                    delay(1000);
                }
        ...
        void _state_3() {
            if(this->state == 3) { 
                ...
                if (this->storage.data.calibration_saved != 1)
                {
                    ...
                    this->storage.data.az_offset = this->az_offset;
                    this->storage.data.gx_offset = this->gx_offset;
                    this->storage.data.gy_offset = this->gy_offset;
                    this->storage.data.gz_offset = this->gz_offset;
                    this->storage.save();
                }
